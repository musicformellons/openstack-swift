...
class Swift {
  constructor (container) {
    this._client = pkgcloud.storage.createClient({
      provider: getenv('SKEEP_SWIFT_PROVIDER'),
      username: getenv('SKEEP_SWIFT_USERNAME'),
      password: getenv('SKEEP_SWIFT_PASSWORD'),
      authUrl: getenv('SKEEP_SWIFT_AUTHURL'),
      region: getenv('SKEEP_SWIFT_REGION')
    })
